...
export default function RoofScroll({ images, companyConfig }: RoofScrollProps) {
  ...
  const text1Y = useTransform(scrollYProgress, [0.15, 0.2], [0, -20]);
  ...
  // Floating button fades in at 20% scroll
      ...
      <div ref={containerRef} className="relative h-[500vh] bg-[#0a0a0a]">
        <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center">
          ...
          <div className="absolute inset-0 flex flex-col pointer-events-none">
            ...
            {/* Text 1 */}
            <motion.div
              style={{ opacity: mounted ? text1Opacity : 1, y: mounted ? text1Y : 0 }}
              className="absolute inset-0 flex flex-col items-center justify-center text-center px-4"
            >
              <p className="mb-4 text-sm font-[800] tracking-[0.3em] text-white/50 uppercase">
                {companyConfig.city}&apos;s Trusted Roofing Experts
              </p>
